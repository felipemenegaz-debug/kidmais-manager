...
export default function ContratoAdmin() {
 ...
 <section aria-label="Resumo da contratação"><h2>Resumo da contratação</h2><p>Documento operacional e comercial, separado do contrato jurídico.</p><div className={styles.actions}><a target="_blank" rel="noreferrer" href={`/admin/contratos/resumo?contratoId=${cid}&versaoId=${vid}`}>Visualizar resumo</a><a target="_blank" rel="noreferrer" href={`/admin/contratos/resumo?contratoId=${cid}&versaoId=${vid}&imprimir=1`}>Imprimir resumo</a></div></section>
