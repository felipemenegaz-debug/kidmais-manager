...
import { simularPrecoPacote, criarTabelaPrecoAdmin, incluirPrecoPacoteAdmin, publicarTabelaPrecoAdmin } from "@/lib/comercial/tabelas-preco-admin";
...
const corpo = z.discriminatedUnion("acao", [simular, criar, preco, publicar]);
